...
SLOTH_VULKAN_VERSION = '1.3.216.0'
VULKAN_SDK_EXE_PATH = 'Sloth/vendor/VulkanSDK/VulkanSDK.exe'
...
def CheckVulkanSDK():
    if (VULKAN_SDK is None):
        ...
        InstallVulkanPrompt()
        return False
    elif (SLOTH_VULKAN_VERSION not in VULKAN_SDK):
        print(f"Located Vulkan SDK at {VULKAN_SDK}")
        print(f"You don't have the correct Vulkan SDK version! (Sloth requires {SLOTH_VULKAN_VERSION})")
        InstallVulkanPrompt()
        return False
...
OutputDirectory = "Sloth/vendor/VulkanSDK"
