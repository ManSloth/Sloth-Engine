	...
	: Layer("ExampleLayer"), m_CameraController(1280.0f / 720.0f)
{
	...
	Sloth::Ref<Sloth::VertexBuffer> vertexBuffer = Sloth::VertexBuffer::Create(vertices, sizeof(vertices));
	...
	Sloth::Ref<Sloth::IndexBuffer> indexBuffer = Sloth::IndexBuffer::Create(indices, sizeof(indices) / sizeof(uint32_t));
	...
	Sloth::Ref<Sloth::VertexBuffer> squareVB = Sloth::VertexBuffer::Create(squareVertices, sizeof(squareVertices));
	squareVB->SetLayout({
		{ Sloth::ShaderDataType::Float3, "a_Position" },
	...
	Sloth::Ref<Sloth::IndexBuffer> squareIB = Sloth::IndexBuffer::Create(squareIndices, sizeof(squareIndices) / sizeof(uint32_t));
	...
	m_ChernoLogoTexture = Sloth::Texture2D::Create("assets/textures/ChernoLogo.png");
...
void ExampleLayer::OnUpdate(Sloth::Timestep ts)
{
	// Update
	...
	m_Texture->Bind();
	Sloth::Renderer::Submit(textureShader, m_SquareVA, glm::scale(glm::mat4(1.0f), glm::vec3(1.5f)));
...
void ExampleLayer::OnEvent(Sloth::Event& e)
{
